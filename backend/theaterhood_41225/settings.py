"""
Django settings for theaterhood_41225 project.
...
ROOT_URLCONF = 'theaterhood_41225.urls'
...
WSGI_APPLICATION = 'theaterhood_41225.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "theaterhood_41225 API",
    "DESCRIPTION": "API documentation for theaterhood_41225 App",
    "VERSION": "v1",
}
